...
import { ContactComponent } from 'src/app/sectionComponents/contact/contact.component';
    ...
    return {
      ...
      sections:{
        contact: {
          ...
          instances: [{
            ...
            methods: {
              ...
              phoneNumbers: ['+44 (0) 7852 367 400']
            },
          }]
        },
        summary: {
          ...
          instances: [{
            photo: {
              path: 'assets/selfi_.jpg',
              altText: 'Picture of Daron looking out into the distance. He is wearing a greyshirt, the room is mostly grey'
            },
            content: [
        ...
        technical: {
          ...
          componentClass: TechnicalComponent,
          instances: [{
        ...
        education: {
          title: 'Education',
          componentClass: EducationComponent,
          instances:[{
            yearStarted: 1999,
            yearFinished: 2004,
        ...
        personal: {
          ...
          instances: [{
              photo: {
                path: 'assets/music.jpeg',
                altText: 'Picture of some musical notes'
              },
              content: [
        ...
        employment: {
          ...
          componentClass: EmploymentComponent,
          instances: [{
